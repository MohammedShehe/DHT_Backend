...
class HealthProfile {
  static async createOrUpdate(userId, data) {
    const {
      age, gender, height, weight, blood_type, activity_level,
      health_goal, activity_types, blood_pressure, glucose, cholesterol,
      has_diabetes, has_hypertension, has_heart_condition,
      smoker, alcohol_consumer, medications, allergies, medical_conditions
    } = data;
    ...
    if (existing.length > 0) {
      await db.query(
        ...
        [
          ...
          activity_level, health_goal, activity_types,
          blood_pressure, glucose, cholesterol,
          has_diabetes || 0, has_hypertension || 0, has_heart_condition || 0,
          smoker || 0, alcohol_consumer || 0,
          medications, allergies, medical_conditions,
          userId
        ]
      );
